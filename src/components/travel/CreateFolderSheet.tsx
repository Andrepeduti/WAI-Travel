...
export function CreateFolderSheet({ isOpen, onClose, onSubmit }: CreateFolderSheetProps) {
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <input
                  ref={inputRef}
                  type="text"
                  placeholder="Ex: Restaurantes, Dia 1"
                  value={name}
                  onChange={(e) => setName(e.target.value.slice(0, 250))}
                  maxLength={250}
